...
typedef OnScrollXListener = Function(double x);
typedef OnScrollYListener = Function(double y);

class MethodChannelWebViewPlatform implements WebViewPlatformController {
  final OnScrollXListener xlistener;
  final OnScrollYListener ylistener;

  MethodChannelWebViewPlatform(
      int id, this._platformCallbacksHandler, this.xlistener, this.ylistener)
  ...
  Future<bool> _onMethodCall(MethodCall call) async {
    switch (call.method) {
      case 'javascriptChannelMessage':
        ...
        _platformCallbacksHandler.onJavaScriptChannelMessage(channel, message,type);
        return true;
      ...
      case 'onScrollXChanged':
        if (xlistener != null) {
          xlistener(call.arguments['xDirection']);
        }
        break;
      case 'onScrollYChanged':
        if (ylistener != null) {
          ylistener(call.arguments['yDirection']);
        }
        break;
    }
