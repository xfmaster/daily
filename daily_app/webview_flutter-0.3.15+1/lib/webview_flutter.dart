...
class JavascriptMessage {
  ...
  const JavascriptMessage(this.type, this.message) : assert(message != null);
...
class _WebViewState extends State<WebView> {
  ...
  Widget build(BuildContext context) {
    return WebView.platform.build(
      ...
      yListener: widget.ylistener,
      xListener: widget.xlistener,
    );
  }
...
class _PlatformCallbacksHandler implements WebViewPlatformCallbacksHandler {
  ...
  @override
  void onJavaScriptChannelMessage(String channel, String message, String type) {
    _javascriptChannels[channel]
        .onMessageReceived(JavascriptMessage(type, message));
  }
