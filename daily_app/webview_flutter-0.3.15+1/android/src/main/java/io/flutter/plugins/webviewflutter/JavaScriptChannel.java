...
class JavaScriptChannel {
    ...
    private final WebView platformThreadHandler;
     ...
     */
    JavaScriptChannel(
            MethodChannel methodChannel, String javaScriptChannelName, WebView platformThreadHandler) {
    ...
    @JavascriptInterface
    public void openNativePage(final String type, final String message) {
