...
public class FlutterWebView implements PlatformView, MethodCallHandler {
    ...
    FlutterWebView(
        ...
        webView.setOnScrollChangedCallback(new InputAwareWebView.OnScrollChangedCallback() {
            @Override
            public void onScroll(int x, int y, int oldx, int oldy) {
                Map<String, Object> yDirection = new HashMap<>();
                yDirection.put("yDirection", (double) y);
                methodChannel.invokeMethod("onScrollYChanged", yDirection);
                Map<String, Object> xDirection = new HashMap<>();
                xDirection.put("xDirection", (double) x);
                methodChannel.invokeMethod("onScrollXChanged", xDirection);
            }
        });
    ...
    private void registerJavaScriptChannelNames(List<String> channelNames) {
        for (String channelName : channelNames) {
            webView.addJavascriptInterface(
                    new JavaScriptChannel(methodChannel, channelName, webView), channelName);
        }
    }
